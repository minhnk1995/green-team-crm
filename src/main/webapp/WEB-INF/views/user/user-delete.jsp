...
<div class="container page__container mt-5">
	...
	<a class="btn btn-success mt-3 d-inline-flex" style="width:200px;" href="<%= request.getContextPath() + UrlConst.HOME%>">
...
<div id="modal-delete-user" class="modal fade" tabindex="-1"
	role="dialog" aria-labelledby="modal-standard-title" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<form action="<%= request.getContextPath() + UrlConst.USER_DELETE %>/id?${curentUser.id}" method="post" class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modal-standard-title">Xóa Nhân Viên</h5>
			...
			<div class="modal-body">
				<p>Nhân viên này sẽ bị xóa vĩnh viễn không thể khôi phục! Bạn có
					chắc chắc muốn thực hiện hành động này!!</p>
			</div>
			<!-- // END .modal-body -->
